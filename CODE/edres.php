...
<tr>
	...
	<td colspan=3><input type=text name=txtrollnumber size=50 value="<?php echo $v['r_rollnumber'];?>"></td>
</tr>
<tr>
...
<?php
		...
		$upd="update reservation set r_chkindt=$cid,r_chkoutdt=$cod,r_rooms=$norm,r_name=$name,r_email=$email,r_rollnumber=$rollnumber,r_phone=$tele,r_address=$addr,r_spanyreq=$spreq where r_email=$emailn and r_chkindt=$cind";
		$u=mysqli_query($upd);
		echo "<br><font color=7c0000 size=5>THANK YOU</font>";
